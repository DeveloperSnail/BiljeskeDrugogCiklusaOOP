...
public class ParStaticnihMetodaCollections {
	...
	public static void main(String[] args) {
		...
		Collections.replaceAll(lista, "brate", "sestra");
		System.out.println("Zamijeni svaku pojavu riječi \"brate\" s \"sestra\": " + lista);
		
		Collections.fill(lista, "sestra");
		System.out.println("Svaki element zamijenjen s sestra: " + lista);
